...
interface TeamsVideoCallModalFixedProps {
  call: Call;
  user: User;
  onEndCall: () => void;
  onClose: () => void;
...
export const TeamsVideoCallModalFixed: React.FC<TeamsVideoCallModalFixedProps> = ({
  call,
  user,
  onEndCall,
  onClose
  ...
  // Sync participant state with call state
  useEffect(() => {
  ...
  }, [callState.isVideoEnabled, callState.isAudioEnabled, user.id]);
  ...
  const handleEndCall = async () => {
    console.log('TeamsVideoCallModalFixed: Ending call...');
  ...
  const handleMoreOptionsToggle = () => {
    console.log('Toggling more options...');
      ...
      <div className="flex-1 flex relative">
          ...
          <div className="w-80 bg-white dark:bg-gray-800 border-l border-gray-200 dark:border-gray-700 flex flex-col">
            ...
            <div className="flex-1 p-4 space-y-3">
              <button className="w-full text-left p-3 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700">
                <div className="font-medium text-gray-900 dark:text-white">Gallery View</div>
                <div className="text-sm text-gray-500 dark:text-gray-400">Show all participants</div>
              </button>
              <button className="w-full text-left p-3 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700">
                <div className="font-medium text-gray-900 dark:text-white">Speaker View</div>
                <div className="text-sm text-gray-500 dark:text-gray-400">Focus on current speaker</div>
              </button>
              <button className="w-full text-left p-3 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700">
                <div className="font-medium text-gray-900 dark:text-white">Together Mode</div>
                <div className="text-sm text-gray-500 dark:text-gray-400">Virtual background</div>
              </button>
            </div>
          </div>
        )}
        ...
        {showMoreOptions && (
          <div className="w-80 bg-white dark:bg-gray-800 border-l border-gray-200 dark:border-gray-700 flex flex-col">
            ...
            <div className="flex-1 p-4 space-y-3">
              <button className="w-full text-left p-3 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700">
                <div className="font-medium text-gray-900 dark:text-white">Record Meeting</div>
                <div className="text-sm text-gray-500 dark:text-gray-400">Start recording</div>
              </button>
              <button className="w-full text-left p-3 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700">
                <div className="font-medium text-gray-900 dark:text-white">Live Captions</div>
                <div className="text-sm text-gray-500 dark:text-gray-400">Turn on captions</div>
              </button>
              <button className="w-full text-left p-3 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700">
                <div className="font-medium text-gray-900 dark:text-white">Background Effects</div>
                <div className="text-sm text-gray-500 dark:text-gray-400">Blur or change background</div>
              </button>
              <button className="w-full text-left p-3 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700">
                <div className="font-medium text-gray-900 dark:text-white">Settings</div>
                <div className="text-sm text-gray-500 dark:text-gray-400">Audio and video settings</div>
              </button>
            </div>
          </div>
        )}
