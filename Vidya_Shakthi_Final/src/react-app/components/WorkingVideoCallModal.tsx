...
interface WorkingVideoCallModalProps {
  call: Call;
  user: User;
  onEndCall: () => void;
  onClose: () => void;
...
export const WorkingVideoCallModal: React.FC<WorkingVideoCallModalProps> = ({
  call,
  user,
  onEndCall,
  onClose
  ...
  const handleEndCall = () => {
    console.log('WorkingVideoCallModal: Ending call...');
